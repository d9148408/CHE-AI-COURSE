# Unit11 進階補充教材｜製程安全異常偵測 - 深度主題

**課程名稱**：化工資料科學與機器學習實務（CHE-AI-101）  
**Part 3 進階選讀**：本教材為 Unit11 的進階補充，包含完整的 TEP 案例分析、多種進階異常偵測方法、以及深入的數學推導。

> **前置要求**：建議先完成 Part_3/Unit11_Process_Safety_Anomaly_Detection.md 基礎內容後再閱讀本教材。
...
|------|----------|----------|----------|----------|----------|----------|--------|--------|
| 0    | 0.25987  | 3642.6   | 4539.6   | 2704.2   | 75.492   | 120.40   | 63.392 | 53.617 |
...
![TEP關鍵變數時間序列](Unit11_Advanced_Results/TEP_key_variables_timeseries.png)
...
![Scree Plot 與累積變異量曲線](Unit11_Advanced_Results/PCA_scree_plot.png)
...
![正常數據與故障數據 PCA 投影對比](Unit11_Advanced_Results/PCA_2D_projection.png)
...
![Standard PCA vs Kernel PCA 對比](Unit11_Advanced_Results/PCA_vs_KernelPCA.png)
...
![Sparse PCA 第一主成分負荷分布](Unit11_Advanced_Results/SparsePCA_loadings.png)
...
![四種進階異常偵測方法性能對比](Unit11_Advanced_Results/methods_comparison.png)
...
![MSPC 控制圖 - T² 與 SPE](Unit11_Advanced_Results/MSPC_control_charts.png)
...
![SPE 貢獻圖 - 樣本 160](Unit11_Advanced_Results/SPE_contribution_plot.png)
...
![最終性能排名](Unit11_Advanced_Results/final_performance_ranking.png)

**圖9：六種異常檢測方法在 TEP IDV5 故障數據上的性能排名**
